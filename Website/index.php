    ...
    <body>
        ...
        <div class="wrapping">
            <div class="row">
                ...
                <div class="box">
                    <div class="top">
                        <img src="img/rollercoaster.png" alt="achtbaan icon">
                        <h3>Achtbanen</h3>
                    </div>
                    <div class="text">
            ...
            <div class="row">
                <div class="box">
                    <div class="top">
                        <img src="img/quality.png" alt="kwaliteit icon">
                        <h3>Kwaliteit</h3>
                    </div>
                    <div class="text">
                ...
                <div class="box">
                    <div class="top">
                        <img src="img/queing.png" alt="wachtrij icon">
                        <h3>Wachtrij</h3>
                    </div>
                    <div class="text">
                ...
                <div class="box">
                    <div class="top">
                        <img src="img/feedback.png" alt="Beoordeling icon">
                        <h3>Onze klanten</h3>
                    </div>
                    <div class="text">
